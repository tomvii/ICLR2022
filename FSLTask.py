...
# This is for miniImagenet
_datasetFeaturesFiles = {"miniImagenet": None,  # this will be taken from the argparser
                        "sherpa_data": None,    # this will be tkaen from the argparser
}
#                         #  "CUB": "./checkpoints/CUB/WideResNet28_10_S2M2_R/last/novel_features.plk",}
...
def loadDataSet(novel_features_file, dsname='miniImagenet'):    # dsname is redundant here and we dont need it, our base_features_path and novel_features_path take care of it
    ...
    # home = expanduser("~")
    dataset = _load_pickle(novel_features_file)
